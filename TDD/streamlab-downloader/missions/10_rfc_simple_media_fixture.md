# Mission 10 — RFC simple media fixture

## Goal

Use RFC-style absolute segment URLs as an authoritative fixture.

## Red: test prompt

Fixture should return the three `http://media.example.com/*.ts` URLs.

## Rust focus

absolute URL strings, fixture assertions.
...
Parser still only filters non-URI lines.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 10` for hints and solution shape.
