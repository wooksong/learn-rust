# Mission 61 — Choose YouTube media format

## Goal

Select best HLS/DASH/progressive candidate from formats.

## Red: test prompt

Given mixed formats, choose preferred HLS or progressive URL.

## Rust focus

filter, max_by_key, protocol fields.
...
Selection policy should be explicit.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 61` for hints and solution shape.
