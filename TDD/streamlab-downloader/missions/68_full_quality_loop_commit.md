...
Run final checks and create a portfolio-ready commit.

## Red: test prompt

fmt, clippy, tests all pass before commit.

## Rust focus

quality workflow, git.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 68` for hints and solution shape.
