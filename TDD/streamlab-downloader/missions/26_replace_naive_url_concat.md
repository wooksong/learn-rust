# Mission 26 — Replace naive URL concatenation

## Goal

Use characterization tests to replace brittle URL logic.

## Red: test prompt

Tests for absolute, same-dir, nested, and parent-dir references all pass.

## Rust focus

refactoring under tests, error mapping.
...
Add `url` crate only when tests justify it.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 26` for hints and solution shape.
