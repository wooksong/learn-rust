...
Make progress visible with a checklist.

## Red: test prompt

Checklist lists phases and mission completion boxes.
...
Track phase progress, not every tiny assertion.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 66` for hints and solution shape.
