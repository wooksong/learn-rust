...
Turn HTTP error status into a library error.

## Red: test prompt

Mock 404 response; expect error, not successful body.

## Rust focus

error_for_status, typed errors.
...
Decide whether to expose status code in custom error.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 28` for hints and solution shape.
