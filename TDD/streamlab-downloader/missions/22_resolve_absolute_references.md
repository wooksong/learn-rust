...
URL resolver should leave absolute HTTP(S) references unchanged.

## Red: test prompt

Base + absolute reference returns the absolute reference.

## Rust focus

URL concepts, pure functions.
...
This sets a baseline before relative joins.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 22` for hints and solution shape.
