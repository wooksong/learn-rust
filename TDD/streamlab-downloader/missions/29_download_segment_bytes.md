...
Fetch binary segment data as `Vec<u8>`.

## Red: test prompt

Mock segment body `[1,2,3]`; expect those bytes.

## Rust focus

bytes, Vec<u8>, async tests.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 29` for hints and solution shape.
