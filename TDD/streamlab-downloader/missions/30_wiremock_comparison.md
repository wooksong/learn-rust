# Mission 30 — wiremock comparison

## Goal

Recreate one HTTP test using wiremock for comparison.

## Red: test prompt

Same `fetch_text` success behavior passes under wiremock.

## Rust focus

wiremock matchers, async mocks.
...
This is comparative learning, not a migration yet.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 30` for hints and solution shape.
