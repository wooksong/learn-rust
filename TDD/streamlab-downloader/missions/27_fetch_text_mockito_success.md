...
Test HTTP text fetching without real network access.

## Red: test prompt

Mock `GET /master.m3u8` returning `#EXTM3U`; expect body.

## Rust focus

tokio::test, mockito, reqwest.
...
Keep client creation simple at first.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 27` for hints and solution shape.
