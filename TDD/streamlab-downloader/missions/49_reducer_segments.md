# Mission 49 — Reducer for segment events

## Goal

Track segment progress and failures in state.

## Red: test prompt

SegmentFinished increments downloaded and bytes.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 49` for hints and solution shape.
