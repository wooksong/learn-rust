# Mission 53 — Render progress

## Goal

Render progress gauge from AppState.

## Red: test prompt

Downloaded 5 of 10 displays 50% or equivalent gauge.

## Rust focus

Gauge, ratios, division by zero.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 53` for hints and solution shape.
