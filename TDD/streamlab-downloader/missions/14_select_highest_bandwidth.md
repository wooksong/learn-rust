...
Choose the best variant by bandwidth without panicking on empty input.

## Red: test prompt

Given 3 variants, expect the highest; given empty, expect error.

## Rust focus

Iterator::max_by_key, Option to Result.
...
Define empty input behavior before implementation.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 14` for hints and solution shape.
