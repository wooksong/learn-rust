...
Join nested child playlist or segment paths.

## Red: test prompt

Base + `low/index.m3u8` resolves under base directory.

## Rust focus

path joining, URL semantics.
...
Manual slash concatenation is fragile.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 24` for hints and solution shape.
