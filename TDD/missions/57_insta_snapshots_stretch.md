...
Add snapshot tests after UI stabilizes.

## Red: test prompt

Snapshot captures dashboard and passes on repeat run.

## Rust focus

insta, regression testing.
...
Review snapshots intentionally.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 57` for hints and solution shape.
