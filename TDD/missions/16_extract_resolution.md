...
Parse `RESOLUTION=1280x720` when present.

## Red: test prompt

Given a variant with resolution, expect width 1280 and height 720.

## Rust focus

Option, split_once, u32 parsing.
...
Missing resolution should be `None`.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 16` for hints and solution shape.
