...
Add exact commands for running and testing.

## Red: test prompt

README includes `cargo test`, CLI examples, and quality loop.
...
Separate generic HLS from YouTube examples.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 65` for hints and solution shape.
