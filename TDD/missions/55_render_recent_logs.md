...
Show recent downloader events in a log panel.

## Red: test prompt

Given many logs, visible panel shows newest relevant entries.

## Rust focus

iterators, layout constraints.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 55` for hints and solution shape.
