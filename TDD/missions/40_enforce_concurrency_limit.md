...
Ensure no more than N segment downloads run at once.

## Red: test prompt

Instrument active count; maximum observed active requests <= limit.
...
Hold permit for entire request.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 40` for hints and solution shape.
