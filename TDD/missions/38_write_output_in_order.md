# Mission 38 — Write output in order

## Goal

Write collected segment bytes in playlist order.

## Red: test prompt

Given indexed results out of completion order, file bytes are ABC.

## Rust focus

Vec<Option<Vec<u8>>>, AsyncWriteExt.
...
Separate downloading from writing.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 38` for hints and solution shape.
