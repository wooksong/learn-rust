# Mission 59 — yt-dlp JSON spike

## Goal

Experiment with `yt-dlp --dump-single-json`.

## Red: test prompt

Command stdout is captured and saved as fixture for tests.

## Rust focus

Command/process, JSON fixtures.
...
Spike is allowed; clean up afterward.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 59` for hints and solution shape.
