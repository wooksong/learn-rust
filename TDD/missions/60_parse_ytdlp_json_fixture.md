# Mission 60 — Parse yt-dlp JSON fixture

## Goal

Deserialize minimal metadata and formats from saved JSON.

## Red: test prompt

Fixture yields video id, title, and format list.
...
Do not model full yt-dlp schema.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 60` for hints and solution shape.
