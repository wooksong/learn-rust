...
State with 1280x720 variant renders resolution and Mbps.

## Rust focus

formatting, Option display.
...
Missing variant shows not selected.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 54` for hints and solution shape.
