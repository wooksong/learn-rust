...
Document modules, flow, and TDD journey.

## Red: test prompt

README explains library, CLI, TUI, and resolver layers.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 64` for hints and solution shape.
