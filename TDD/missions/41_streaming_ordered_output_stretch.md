...
Write completed contiguous segments without waiting for all tasks.

## Red: test prompt

If segment 0 and 1 are ready, write them while segment 2 continues.

## Rust focus

buffers, next index, async coordination.
...
Stretch after simpler ordered collect works.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 41` for hints and solution shape.
