# Mission 09 — Apple VOD fixture

## Goal

Use the Apple VOD relative fixture as a realistic media playlist test.

## Red: test prompt

Fixture should return `fileSequenceA.ts` through `fileSequenceD.ts`.

## Rust focus

fixtures, source-backed examples.
...
Keep expected list explicit in test.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 09` for hints and solution shape.
