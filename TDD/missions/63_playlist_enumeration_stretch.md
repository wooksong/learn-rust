...
Explore YouTube playlist extraction modes.

## Red: test prompt

Flat playlist returns entries; selected entry can be resolved later.

## Rust focus

yt-dlp flags, metadata tradeoffs.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 63` for hints and solution shape.
