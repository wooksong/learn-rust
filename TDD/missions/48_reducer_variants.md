# Mission 48 — Reducer for variants

## Goal

Update state from master/variant events with pure function tests.

## Red: test prompt

VariantsFound event stores variants and updates status.

## Rust focus

match, mutable references.
...
No terminal or async code in reducer tests.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 48` for hints and solution shape.
