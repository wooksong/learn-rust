...
Trim segment URI lines before returning them.

## Red: test prompt

Given padded and tabbed segment lines, expect clean URI strings.

## Rust focus

str::trim, String ownership.
...
Trim once, then use the trimmed value for checks and output.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 05` for hints and solution shape.
