...
Describe downloader progress as events for the TUI.

## Red: test prompt

Construct events for master fetched and segment finished.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 46` for hints and solution shape.
