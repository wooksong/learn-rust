...
Preserve quoted CODECS value as optional metadata.

## Red: test prompt

Given `CODECS="avc1...,mp4a..."`, expect the inner string.

## Rust focus

quoted strings, commas inside attributes.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 17` for hints and solution shape.
