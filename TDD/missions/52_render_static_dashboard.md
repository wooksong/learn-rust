# Mission 52 — Render static dashboard

## Goal

Render initial Ratatui title/status panel.

## Red: test prompt

Buffer contains app title and status text.

## Rust focus

ratatui Paragraph, Block, TestBackend.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 52` for hints and solution shape.
