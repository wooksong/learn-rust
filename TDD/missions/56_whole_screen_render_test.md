...
Use Ratatui TestBackend to verify full dashboard output.

## Red: test prompt

Rendered screen contains title, progress, variant, and logs.
...
Assert key strings first, not brittle full snapshots.
...
See `../HINTS_AND_SOLUTIONS.md` and search for `Mission 56` for hints and solution shape.
